...
const WhyChooseUs = () => {
  ...
  const outletsCounter = useCountUp({ end: 8, duration: 2500 });
  const customersCounter = useCountUp({ end: 100000, suffix: '+', duration: 3000 });
  ...
  const stats = [
    ...
    { counter: outletsCounter, label: "Bulawayo Branches", icon: MapPin },
  ...
  const testimonials = [
    {
      text: "Best chicken in Bulawayo! The spice blend is incredible.",
      author: "Tendai M.",
  ...
  return (
    <section className="py-20 bg-zinc-50 dark:bg-zinc-900/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 xl:px-12 2xl:px-16 relative">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <Badge className="mb-4 bg-primary/10 text-primary border-primary/20 hover:bg-primary/25">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            ...
            <span className="text-primary relative">
              LUV DAT Chicken
              <div className="absolute -bottom-2 left-0 right-0 h-1 bg-primary opacity-30 rounded-full"></div>
            </span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            has made us the people's choice.
          </p>
        </div>
